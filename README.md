...
LVGL (Light and Versatile Embedded Graphics Library ) example project for IDF version 5.2. That can be in combination with SquareLine Studio for GUI based user interface design.  
